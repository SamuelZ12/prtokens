...
const FOOTER = '*cost uses source-reported values when available; otherwise estimated from token pricing \u00b7 generated by prtokens*';
const RECOGNIZED_FOOTERS = [FOOTER, '*estimated at API rates \u00b7 generated by prtokens*'];
